	...
	<div class="grid gap-4">
		...
		{#if $formData.type === 'photo'}
			<Alert.Root class="bg-zinc-900">
				...
				<Alert.Description>A <b>Photo (For Site)</b> will <u>not</u> appear in the photo gallery on the site. Use a <b>Photo (In Gallery)</b> if you want it to appear in the gallery (you can still use it in the editor)</Alert.Description>
			</Alert.Root>
		{/if}
